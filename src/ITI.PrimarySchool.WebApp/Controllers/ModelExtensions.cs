...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    public static class ModelExtensions
    {
        ...
        public static AssignedClassStudentViewModel ToAssignedClassStudentViewModel(this Class @this)
        {
            return new AssignedClassStudentViewModel
            {
                ClassId = @this.ClassId,
                Name = @this.Name
            };
        ...
        public static AssignedClassTeacherViewModel ToAssignedClassTeacherViewModel( this Class @this )
        {
            return new AssignedClassTeacherViewModel
            {
                ClassId = @this.ClassId,
                Name = @this.Name
            };
