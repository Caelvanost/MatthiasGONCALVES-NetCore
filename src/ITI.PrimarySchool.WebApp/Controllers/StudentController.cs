...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        [HttpPost("{id}/assignStudentClass")]
        public IActionResult AssignClass(int id, [FromBody] AssignClassStudentViewModel model)
        {
            Result result = _studentService.AssignStudentClass(id, model.ClassId);
            return this.CreateResult(result);
        }

        [HttpGet("{id}/assignedStudentClass")]
        public IActionResult AssignedClass(int id)
        {
            Result<Class> result = _studentService.AssignedStudentClass(id);
            return this.CreateResult<Class, AssignedClassStudentViewModel>(result, o =>
            {
                o.ToViewModel = c => c.ToAssignedClassStudentViewModel();
            });
        }
    }
}