...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    ...
    public class TeacherController : Controller
    {
        ...
        [HttpPost( "{id}/assignTeacherClass" )]
        public IActionResult AssignClass( int id, [FromBody] AssignClassTeacherViewModel model )
        {
            Result result = _teacherService.AssignTeacherClass( id, model.ClassId );
            return this.CreateResult( result );
        }

        [HttpGet( "{id}/assignedTeacherClass" )]
        public IActionResult AssignedClass( int id )
        {
            Result<Class> result = _teacherService.AssignedTeacherClass( id );
            return this.CreateResult<Class, AssignedClassTeacherViewModel>( result, o =>
            {
                o.ToViewModel = c => c.ToAssignedClassTeacherViewModel();
            } );
        }
    }
}