...
namespace ITI.PrimarySchool.WebApp.Services
{
    public class TeacherService
    {
        ...
        public Result AssignTeacherClass( int teacherId, int classId )
        {
            Class c = null;
            ...
            _teacherGateway.AssignTeacherClass( teacherId, classId );
            return Result.Success( Status.Ok );
        }

        public Result<Class> AssignedTeacherClass( int teacherId )
        {
